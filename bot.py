...
exercises = {
    "спина": ["Подтягивания", "Тяга штанги в наклоне", "Тяга верхнего блока"],
    "бицепс": ["Подъем штанги на бицепс", "Молотки с гантелями", "Концентрированный подъем"],
    "грудь": ["Жим лежа", "Отжимания на брусьях", "Разводка гантелей"],
